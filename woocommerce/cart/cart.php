...
<div class="row">
    ...
    $product_quantity = woocommerce_quantity_input(
        array(
            ...
            'class'        => 'quantity-input', // Add a class for easier selection
        ),
        $_product,
        false
    );
    ...
    // Ensure the cart is updated when quantity changes.
    if ( isset( $_POST['update_cart'] ) ) {
        WC()->cart->set_quantity( $cart_item_key, $cart_item['quantity'] );
    }

    // No need to echo it again, as it's already included above
